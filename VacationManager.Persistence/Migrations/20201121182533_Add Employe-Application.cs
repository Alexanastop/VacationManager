...
{
    public partial class AddEmployeApplication : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeClaims_Employee_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Employee",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeLogins_Employee_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Employee",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeTokens_Employee_UserId",
                        column: x => x.UserId,
                        principalSchema: "Identity",
                        principalTable: "Employee",
                        principalColumn: "Id",
